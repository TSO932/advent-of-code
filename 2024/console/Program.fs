...
printfn "Day  9 Part 1: %i" (Day09Part1.run ((readInput 9).[0]))
printfn "Day  9 Part 2: %i" (Day09Part2.run ((readInput 9).[0]))
printfn "Day 11 Part 1: %i" (Day11Part1.run ((readInput 11).[0]))
printfn "Day 11 Part 2: %i" (Day11Part2.run ((readInput 11).[0]))
